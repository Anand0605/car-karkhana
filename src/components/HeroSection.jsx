...
//   return (
//     <div className="flex justify-start items-center flex-col  text-white px-4 w-full min-h-[29rem] py-8 bg-red-600">
...
//       </div>
//       <div className="min-w-[85%] relative">
//         {/* Tab Section */}
//         <div className="w-full h-[50%] text-black  bg-white rounded flex items-center">
...
//           <button className="bg-blue-400  text-white px-2 py-2 ">Continue</button>
//         </div>
